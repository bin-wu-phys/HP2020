...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\begin{frame}{\bf\huge In principle, we may deal with the full problem.}
\vspace{4mm}
\begin{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\begin{frame}{\bf\huge Instability}	\vspace{2mm}
\begin{align}
\text{\tiny $G_{22}^{a\mu,b\nu}(X, p)$}=\begin{array}{c}
\includegraphics[width=0.45\textwidth]{fig/G22NLO}
\end{array}\text{\tiny $\to  2\pi\delta(p^2) \delta^{ab}
...
\begin{enumerate}
\begin{itemize}
    \item{\large Radiative energy loss: for $t_f \ll \tau$}
    \begin{align}
