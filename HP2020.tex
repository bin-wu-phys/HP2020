...
\vspace*{\fill}
\begin{center}
{\Huge\bf\color{gray} Hard Probes \& Bulk in pp, pA and AA}
\end{center}
\vspace*{\fill}
\end{frame}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\begin{frame}{\bf\huge Studies from QCD first principles}	\vspace{4mm}
\begin{center}
\includegraphics[width=0.65\textwidth]{fig/RAA_jet
\vspace{4mm}
\begin{enumerate}
\item{There are many "good" models for jet quenching.}
\vspace{4mm}
\item{Differences can mostly trace back to the modelling of  bulk matter.}
\vspace{4mm}
\item{The top-down approach from QCD can help.}
\end{enumerate}
\end{frame}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vspace*{\fill}
\begin{center}
{\Huge\bf\color{gray} Going Beyond Hydrodynamics}
\end{center}
\vspace*{\fill}
\end{frame}
%
...
\vspace{4mm}
\begin{center}
\includegraphics[width=0.7\textwidth]{fig/onehit}
\end{center}
\vspace{4mm}
